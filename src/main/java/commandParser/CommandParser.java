...
public class CommandParser {
    ...
    /**
     * Check validity of parameters for find command
     * @param inputParts
     * @return a FindCommand object if the parameter is valid, an InvalidCommand object if the second parameter is missing
     */
